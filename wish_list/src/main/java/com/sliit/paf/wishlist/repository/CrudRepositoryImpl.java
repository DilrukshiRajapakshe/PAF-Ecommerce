...
/*class Child extends Parent implements Serializable. It implies that the class can be serialized and
 it's state can be stored on to the disk in a file. when we extend a class that implements
    serializable we need not specify it again*/
